...
class kozai_struct
{
	private:
		...
		//and the initial 19 dimensional vector (allocated outside class)
		vec j1_init;
		vec j2_init;
		vec e1_init;
		vec e2_init;
	...
	public:
		...
		kozai_struct(double ia1=365.11437, double ia2=2865.7776, double ie1=0.32229033, double ie2=0.35653592, double iinc=93.920405, 
			  ...
			  bool iquad=false, bool ioct=false, bool ioctel=false, bool icrossnaoz=false, bool icrosslim=false, bool iperi=false, bool iouterperi=false, bool iso=false, bool iss=false, bool rad=false)
			{	
				a1=ia1*AU;
				a2=ia2*AU;
				e1=ie1;
		...
		void set_outerpericenter(bool outerpericenter_i) {outerpericenter=outerpericenter_i;}
		bool get_outerpericenter() {return outerpericenter;}
